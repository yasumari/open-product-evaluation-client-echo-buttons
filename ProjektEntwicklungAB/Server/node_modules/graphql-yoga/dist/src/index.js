...
var GraphQLServer = /** @class */ (function () {
    function GraphQLServer(props) {
        ...
        if (props.schema) {
            ...
            var directiveResolvers = props.directiveResolvers, schemaDirectives = props.schemaDirectives, resolvers = props.resolvers, resolverValidationOptions = props.resolverValidationOptions, typeDefs = props.typeDefs;
        ...
        if (props.middlewares) {
            this.executableSchema = graphql_middleware_1.applyMiddleware.apply(void 0, [this.executableSchema].concat(props.middlewares));
        }
    }
    ...
    GraphQLServer.prototype.createHttpServer = function (options) {
        ...
        if (this.options.playground) {
            var playgroundOptions = this.subscriptionServerOptions
                ? {
